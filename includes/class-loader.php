...
class Secure_Aura_Loader
{
    ...
    public function load_admin_classes()
    {
        ...
        $admin_classes = [
            ...
            'Secure_Aura_Setup_Wizard' => SECURE_AURA_ADMIN_DIR . 'class-setup-wizard.php',
        ];
    ...
    public function late_load_classes()
    {
        ...
        $late_classes = [
            ...
            'Secure_Aura_Email_Notifications' => SECURE_AURA_INCLUDES_DIR . 'class-email-notifications.php',
        ];
